...
.method public static zza(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 8
    invoke-static {v0}, Lcom/google/firebase/auth/internal/zzaz;->zzb(Ljava/lang/String;)Ljava/util/Map;
...
.method public static zzb(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 3
    invoke-static {v0}, Lcom/google/firebase/auth/internal/zzaz;->zzc(Lorg/json/JSONObject;)Ljava/util/Map;
...
.method static zzc(Lorg/json/JSONObject;)Ljava/util/Map;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v3}, Lcom/google/firebase/auth/internal/zzaz;->zzd(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-static {v3}, Lcom/google/firebase/auth/internal/zzaz;->zzc(Lorg/json/JSONObject;)Ljava/util/Map;
...
.method static zzd(Lorg/json/JSONArray;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2}, Lcom/google/firebase/auth/internal/zzaz;->zzd(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-static {v2}, Lcom/google/firebase/auth/internal/zzaz;->zzc(Lorg/json/JSONObject;)Ljava/util/Map;
