.class final Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;
...
.method constructor <init>(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/String;Ljava/util/List;Ljava/lang/Integer;Ljava/util/List;Ljava/util/List;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$poster:Ljava/lang/String;

    iput-object p2, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$year:Ljava/lang/Integer;

    iput-object p3, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$description:Ljava/lang/String;

    iput-object p4, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$tags:Ljava/util/List;

    iput-object p5, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$rating:Ljava/lang/Integer;

    iput-object p6, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$actors:Ljava/util/List;

    iput-object p7, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$recommendations:Ljava/util/List;

    iput-object p8, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$trailer:Ljava/lang/String;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->invoke(Lcom/lagradost/cloudstream3/TvSeriesLoadResponse;)V
...
.method public final invoke(Lcom/lagradost/cloudstream3/TvSeriesLoadResponse;)V
    ...
    .line 166
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$poster:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/TvSeriesLoadResponse;->setPosterUrl(Ljava/lang/String;)V

    .line 167
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$year:Ljava/lang/Integer;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/TvSeriesLoadResponse;->setYear(Ljava/lang/Integer;)V

    .line 168
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$description:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/TvSeriesLoadResponse;->setPlot(Ljava/lang/String;)V

    .line 169
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$tags:Ljava/util/List;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/TvSeriesLoadResponse;->setTags(Ljava/util/List;)V

    .line 170
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$rating:Ljava/lang/Integer;
    ...
    iget-object v2, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$actors:Ljava/util/List;
    ...
    .line 172
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$recommendations:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/LayarKacaProvider$load$2;->$trailer:Ljava/lang/String;
