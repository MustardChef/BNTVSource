.class final Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;
...
.method constructor <init>(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/String;Ljava/util/List;Ljava/lang/Integer;Ljava/util/List;Ljava/util/List;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$poster:Ljava/lang/String;

    iput-object p2, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$year:Ljava/lang/Integer;

    iput-object p3, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$description:Ljava/lang/String;

    iput-object p4, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$tags:Ljava/util/List;

    iput-object p5, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$rating:Ljava/lang/Integer;

    iput-object p6, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$actors:Ljava/util/List;

    iput-object p7, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$recommendations:Ljava/util/List;

    iput-object p8, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$trailer:Ljava/lang/String;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->invoke(Lcom/lagradost/cloudstream3/MovieLoadResponse;)V
...
.method public final invoke(Lcom/lagradost/cloudstream3/MovieLoadResponse;)V
    ...
    .line 97
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$poster:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/MovieLoadResponse;->setPosterUrl(Ljava/lang/String;)V

    .line 98
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$year:Ljava/lang/Integer;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/MovieLoadResponse;->setYear(Ljava/lang/Integer;)V

    .line 99
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$description:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/MovieLoadResponse;->setPlot(Ljava/lang/String;)V

    .line 100
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$tags:Ljava/util/List;

    invoke-virtual {p1, v0}, Lcom/lagradost/cloudstream3/MovieLoadResponse;->setTags(Ljava/util/List;)V

    .line 101
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$rating:Ljava/lang/Integer;
    ...
    iget-object v2, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$actors:Ljava/util/List;
    ...
    .line 103
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$recommendations:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/lagradost/cloudstream3/movieproviders/YomoviesProvider$load$3;->$trailer:Ljava/lang/String;
